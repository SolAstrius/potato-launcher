...
fn inner(dir: &Path) -> Result<(), Box<dyn Error>> {
    ...
    content.push_str("// DO NOT EDIT THIS FILE. THIS FILE IS AUTOGENERATED BY crates/i18n/build.rs\n\n");
    ...
    content.push_str("pub static LANG: std::sync::atomic::AtomicU8 = std::sync::atomic::AtomicU8::new(0);\n\n");
